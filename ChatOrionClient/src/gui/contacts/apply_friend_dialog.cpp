    ...
    _label_point(2,6)
{
    ...
    ui->selected_multiple_lb->setPixmap(QPixmap(":/pic/打钩.png"));
...
bool ApplyFriend::eventFilter(QObject *obj, QEvent *event)
{
    if (event->type() == QEvent::MouseButtonPress)
    {
        ...
        if (mouse_event)
        {
            ...
            {
                ui->selected_chat_only_lb->setPixmap(QPixmap(":/pic/打钩.png"));
                ui->selected_multiple_lb->setPixmap(QPixmap(":/pic/close_transparent.png"));
            ...
            {
                ui->selected_multiple_lb->setPixmap(QPixmap(":/pic/打钩.png"));
                ui->selected_chat_only_lb->setPixmap(QPixmap(":/pic/close_transparent.png"));
