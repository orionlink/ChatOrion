...
KeyChainClass::KeyChainClass(QObject *parent)
    : QObject(parent),
      m_readCredentialJob(QLatin1String("keychain.ChatOrion.project.app")),
      m_writeCredentialJob(QLatin1String("keychain.ChatOrion.project.app")),
      m_deleteCredentialJob(QLatin1String("keychain.ChatOrion.project.app"))
{
